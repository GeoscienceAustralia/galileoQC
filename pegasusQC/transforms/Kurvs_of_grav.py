...
def Kurvs_of_grav(gravity, scale=1000.0):
    """
    ...
    gne = xrft.idft(gne_fft, detrend='linear', window=True, true_phase=True, true_amplitude=True)
    guv = xrft.idft(guv_fft, detrend='linear', window=True, true_phase=True, true_amplitude=True)
    
    return gne.real * scale, guv.real * scale
