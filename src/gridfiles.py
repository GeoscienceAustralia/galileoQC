...
TODO: add in a function to import XYZ grid files (columnar data of X, Y, Z) and
    convert to ERMapper format. Optionally, the user can specify info for the
    header file, like datum and projection.
'''
import numpy as np
